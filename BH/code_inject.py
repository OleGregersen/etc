# Script to inject shellcode in calc.exe
...
#Address of equals button found with codecoverage script
equals_button = 0x01005D51 # Might need to change

memory_file = "WinXPSP2.vmem" # Might need to change
slack_space = None
...
sys.path.append("PATH") # Change to volatility path
